...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE Medical CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE Maintenance CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE Chef CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE Guards CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE Certification CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE WorksAt CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE Employees CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE Amenities CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE Cells CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE PrisonInfo CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE PrisonSecurity CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE Sentence CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE Club CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE MedicalData CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE InmatesInfo CASCADE CONSTRAINTS';
  EXECUTE IMMEDIATE 'DROP TABLE InmatesCell CASCADE CONSTRAINTS';
EXCEPTION
  WHEN OTHERS THEN
